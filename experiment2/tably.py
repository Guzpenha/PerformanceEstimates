...
# adapted from https://github.com/narimiran/tably
...
{indent}\tiny\centering{label}{caption}
...
class Tably:
    ...
    def __init__(self, args):
        ...
        self.captions = args.caption.split("|")
    ...
    def run(self):
        ...
        for (caption,file) in zip(self.captions,self.files):
            table = self.create_table(file,caption)
    ...
    def create_table(self, file, caption):
